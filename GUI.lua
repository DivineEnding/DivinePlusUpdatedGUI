...
DIVINE.Text = "Divine+ b1.2 | DivineEnding#1234"
...
INFINITEINJECTOR.MouseButton1Down:connect(function()
	game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("[Divine+] Injected Infinite Yield!", "All")
